 ...
 * that receives some kind of unexpected or otherwise invalid input. It
 *subclasses
...
/*!
 * \brief This class represents an exception being thrown due to an input/output
 *error.
 *
 * This exception could be thrown by anything, for example, from being unable to
 *create a new
 * directory to being unable to open a file for reading. In theory, the what()
 *text should
