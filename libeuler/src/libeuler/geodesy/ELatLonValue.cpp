...
/*!
 * This is our copy constructor, which creates a new latitude/longitude value
 *equal to
...
/*!
 * This is one of our single-value constructors. It takes a single angle
 *measurement, in either degrees
 ...
 */
ELatLonValue::ELatLonValue(mpfr_t v, ELatLonValue::ValueType t,
                           ELatLonValue::ValueDirection d)
 ...
 * \param d The direction of the angle - NSEW or "None".
 */
ELatLonValue::ELatLonValue(long double v, ELatLonValue::ValueType t,
                           ELatLonValue::ValueDirection d)
        : precision(ELatLonValue::DEFAULT_PRECISION), direction(d)
{
	mpfr_init2(degrees, getPrecision());
...
/*!
 * This constructor creates a new latitude/longitude value form the given value
 *in
 ...
 */
ELatLonValue::ELatLonValue(double d, double m, double s,
                           ELatLonValue::ValueDirection di)
 ...
 * \param di The direction of the angle - NSEW or "None".
 */
ELatLonValue::ELatLonValue(mpfr_t d, mpfr_t m, mpfr_t s,
                           ELatLonValue::ValueDirection di)
        : precision(ELatLonValue::DEFAULT_PRECISION), direction(di)
{
	mpfr_init2(degrees, getPrecision());
...
/*!
 * This is our equivalence operator. It tests if our value is equal to that of
 *the given other
 * value. Note that this is comparing floating point numbers; this can return
 *false in unexpected
...
bool ELatLonValue::operator==(const ELatLonValue &o) const
{
	if(direction != o.direction)
		return false;
	if(!mpfr_equal_p(seconds, o.seconds))
		return false;
	if(!mpfr_equal_p(minutes, o.minutes))
		return false;
	if(!mpfr_equal_p(degrees, o.degrees))
		return false;
...
/*!
 * This function simply returns the precision our object is currently using
 *internally.
 *
...
/*!
 * This function sets the number of bits of precision this class uses
 *internally. Note that calling this function
 * will update it immediately, invalidating any value this object is storing. If
 *you need to call this, call it
 * first.
 *
...
{
	return ((direction == ELatLonValue::North) ||
...
{
	return ((direction == ELatLonValue::East) ||
	        (direction == ELatLonValue::West) ||
	        (direction == ELatLonValue::None));
}

/*!
 * This function returns the degrees component of our value in
 *degrees/minutes/seconds format. Note
...
/*!
 * This function returns the minutes component of our value in
 *degrees/minutes/seconds format. Note
 * that, when normalized, this value is always integral - no precision is lost.
 *
...
/*!
 * This function returns the seconds component of our value in
 *degrees/minutes/seconds format. Note
 * that, when normalized, this is the only value that is not integral. If we
...
/*!
 * This function returns our LatLonValue's value as a single angle measurement,
...
/*!
 * This function normalizes our measurement. We make sure our internal values
 * are all positive (sign/direction is
 * denoted by "direction"), and we make sure that our value is < 180deg (if it
 * is not, it can be represented equivalently
...
/*!
 * This function sets our LatLonValue's value based on the single value given in
 *either degrees or
 * radians.
 *
