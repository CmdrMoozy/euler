...
public:
	...
	EGeoCoord
	getMidpointTo(const EGeoCoord &o,
	              mpfr_prec_t p = ELatLonValue::DEFAULT_PRECISION) const;

	void
	getDistanceTo(mpfr_t d, const EGeoCoord &b,
	              mpfr_prec_t p = ELatLonValue::DEFAULT_PRECISION) const;
...
private:
	...
	void distanceCalculation(mpfr_t d, const EGeoCoord &cA,
