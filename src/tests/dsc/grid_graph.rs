...
const TEST_GRID_GRAPH_VALUES: &'static [&'static [i64]] = &[&[131, 201, 630, 537, 805],
                                                            &[673, 96, 803, 699, 732],
                                                            &[234, 342, 746, 497, 524],
                                                            &[103, 965, 422, 121, 37],
                                                            &[18, 150, 111, 956, 331]];
...
fn test_load_weights() {
    ...
    assert_eq!(EXPECTED_TEST_GRAPH_MINIMUM_WEIGHT,
...
fn test_grid_graph_pathfinding() {
    ...
    let graph = GridGraph::new(weights,
                               ...
                               (0, 0),
                               (4, 4));
    let search_result = dijkstra(graph.get_graph(),
