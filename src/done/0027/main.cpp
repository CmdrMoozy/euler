 ...
 * that produces the longest maximum number of primes for consecutive values
...
constexpr int PRIME_PRECISION = 200;

constexpr int EXPECTED_RESULT = -59231;
 ...
 * coefficients.
 */
int polynomial(int n, int a, int b)
{
	return ((n * n) + (a * n) + b);
}
