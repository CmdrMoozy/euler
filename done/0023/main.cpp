 ...
 * the sum of two abundant numbers. However, this upper limit cannot be reduced by
...
// We reduce the upper limit as per: http://en.wikipedia.org/wiki/Abundant_number
#define LIMIT 20161
