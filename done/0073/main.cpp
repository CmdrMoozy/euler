 ...
 * LOWER_TARGET_D and
 * UPPER_TARGET_N / UPPER_TARGET_D, for every denominator from 1 to
 * DENOMINATOR_LIMIT
 * (inclusive).
 */
...
int main(void)
{
	try
	{
		...
		/*
		 * At this point, we just continuously calculate the next term
		 * until we reach our lower limit. The formula for
		...
		std::cout << "The number of fractions between " << lower
		          << " and " << upper << " is: " << count << ".\n";
